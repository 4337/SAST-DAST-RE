...
Z formalnego punktu widzenia błąd nawet w przypadku zwykłego "BSOD-a" jest podatnością, ponieważ oddziałuje na dostępność systemu z poziomu nisko uprzywilejowanego konta użykownika, <br/>w tym sensie że np. na serwerach często nie posiadamy uprawnienia "SeShutdownPrivilege".<br/>
